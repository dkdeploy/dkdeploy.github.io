...
(function($) {
    ...
    var tocContainerHTML = '<div id="toc-container"><table class="toc" id="toc"><tbody><tr><td>%1<select size="1">%2</select></td></tr></tbody></table></div>';
    ...
    function createLevelHTML(anchorId, tocLevel, tocSection, tocNumber, tocText, tocInner) {
        ...
        return '<option value="%0">%1.%2. %3</option>\n'
            .replace('%1', tocLevel)
            .replace('%2', tocNumber)
            .replace('%3', tocText)
            .replace('%0', link);
